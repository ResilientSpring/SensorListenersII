...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextSensorAccelerometor = (TextView) findViewById(R.id.label_accelerometer);
        ...
        if (mSensorAccelerometer == null) { mTextSensorAccelerometor.setText(sensor_error); }
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType) {
            ...
            case Sensor.TYPE_ACCELEROMETER:
                ...
                mTextSensorAccelerometor.setText(getResources().getString(
                        R.string.label_accelerometer, currentValueX));
                mTextSensorAccelerometor.setText(getResources().getString(
                        R.string.label_accelerometer, currentValueY));
                mTextSensorAccelerometor.setText(getResources().getString(
                        R.string.label_accelerometer, currentValueZ));
